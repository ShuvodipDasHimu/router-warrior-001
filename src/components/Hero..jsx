...
const Hero = () => {
  return <div className='w-8/10 mx-auto mt-8 text-center bg-linear-to-b from-[#EFEFEF] to-[#FFFFFF] p-16 rounded-2xl border border-4 border-white'>
  ...
  <input placeholder='Search any Doctor'type='text'
    className='w-2/5 h-12 px-4 mb-3  bg-white border border-gray-300 rounded-2xl shadow-sm appearance-none md:mr-2 md:mb-0 focus:outline-none focus:shadow-outline'/>
